...
function Index({ permissions, count, page, termSearch, can }) {
    ...
    const getHref = useCallback(
        item => can.view ? route('permissions.show', item.id) : null,
        [can.view],
    );

    return (
        <AuthenticatedLayout
            titleChildren="Gerenciamento de Permissões"
            breadcrumbs={[{ label: 'Permissões', url: route('permissions.index') }]}
        >
            ...
            <DataTable
                ...
                href={getHref}
                empty="Nenhuma permissão encontrada."
            />
